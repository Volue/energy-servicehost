 ...
 *
 * $Id: tvhasht.cc 18623 2000-03-03 08:28:13Z sih $
 *
 ...
 *
 * Revision 7.10  1996/08/09 19:35:22  hart
 * HP (aCC compiler) port
 *
 * Revision 7.9  1996/02/18 01:48:57  griswolf
 ...
 *
 * Revision 7.3  1995/11/17 08:15:43  jims
...
RWDEFINE_PERSISTABLE_TEMPLATE_3(RWTValHashMultiSet)

template <class T, class H, class EQ, class S>
void rwSaveGuts(S& str, const RWTValHashMultiSet<T,H,EQ>& c)
{
  ...
  typename RWTValHashMultiSet<T,H,EQ>::const_iterator it = c.begin();
...
template <class T, class H, class EQ, class S>
void rwRestoreGuts(S& str, RWTValHashMultiSet<T,H,EQ>& c)
{
  typedef typename RWTValHashMultiSet<T,H,EQ>::size_type size_type;
  typename RWTValHashMultiSet<T,H,EQ>::size_type count;
#ifdef RW_FIX_XSIZE_T
  str.getSizeT(count);
#else
  str >> count;
