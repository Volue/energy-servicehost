========================================================================
    ACTIVE TEMPLATE LIBRARY : CfgServer Project Overview
========================================================================

AppWizard has created this CfgServer project for you to use as the starting point for
...
_CfgServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CfgServer_i.h)
        GUID definitions                                (CfgServer_i.c)
        A type library                                  (CfgServer.tlb)
        Marshaling code                                 (CfgServer_d.c and ICfgServer_p.c)
CfgServer.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named CfgServer.pch and a precompiled types file named StdAfx.obj.
...
CfgServerps.vcproj
	...
	dlldata.c, CfgServer_i.c and CfgServer_p.c which are required
