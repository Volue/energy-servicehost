...
namespace endpoint_passive
{
    ...
    class PassiveEndpoint
    {
        ...
        public static void Main(string[] args)
        {
            ...
            endpoint.SetIdentity("MZ Automation", "passive-endpoint", "1");
            endpoint.SetLocalApTitle("1.1.1.999.1", 12);
            //endpoint.SetLocalIpAddress("127.0.0.1");
            ...
            client.SetRemoteApTitle("1.1.1.999.2", 12);
            ...
            if (endpoint.WaitForState(EndpointState.LISTENING, 1000))
            {
                ...
                while (running)
                {
                    ...
                    server.SendInformationMessage(null, 1, 1, msgId, "test info message (from passive endpoint)");
                    msgId++;
