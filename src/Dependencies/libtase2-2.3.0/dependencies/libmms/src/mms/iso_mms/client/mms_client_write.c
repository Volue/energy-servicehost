...
createAlternateAccessIndex(uint32_t index, uint32_t elementCount)
{
...
static void
deleteAlternateAccessIndex(AlternateAccess_t* alternateAccess)
{
...
createAlternateAccessComponent(const char* componentName)
{
    ...
    alternateAccess->list.array[0]->choice.unnamed->choice.selectAccess.present = AlternateAccessSelection__selectAccess_PR_component;
    alternateAccess->list.array[0]->choice.unnamed->choice.selectAccess.choice.component.buf = (uint8_t*) componentName;
    alternateAccess->list.array[0]->choice.unnamed->choice.selectAccess.choice.component.size = strlen(componentName);
        ...
        ByteBuffer* writeBuffer)
{
    ...
    for (i = 0; i < numberOfItems; i++) {
        ...
        request->variableAccessSpecification.choice.listOfVariable.list.array[i] =
                    createNewVariableSpecification(domainId, itemId, NULL, false);
		...
		ByteBuffer* writeBuffer, bool aaspecific)
{
	...
	request->variableAccessSpecification.choice.listOfVariable.list.array[0] =
			createNewVariableSpecification(domainId, itemId, NULL, aaspecific);
        ...
        MmsValue* value, ByteBuffer* writeBuffer)
{
    ...
    request->variableAccessSpecification.choice.listOfVariable.list.array =
            (ListOfVariableSeq_t**) GLOBAL_CALLOC(1, sizeof(ListOfVariableSeq_t*));
    request->variableAccessSpecification.choice.listOfVariable.list.array[0] =
            createNewVariableSpecification(domainId, itemId, componentName, false);
    ...
    /* Free ASN structure */
    deleteAlternateAccessComponent(request->variableAccessSpecification.choice.listOfVariable.list.array[0]->alternateAccess);
        ...
        ByteBuffer* writeBuffer)
{
    ...
    ListOfVariableSeq_t* variableIdentifier = createNewVariableSpecification(domainId, itemId, NULL, false);
    variableIdentifier->alternateAccess = createAlternateAccessIndex(startIndex, elementCount);
    ...
    /* Free ASN structure */
    deleteAlternateAccessIndex(variableIdentifier->alternateAccess);
