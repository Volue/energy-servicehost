namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="sendTimeseriesGS2Response", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class sendTimeseriesGS2Response
    {
        ...
        public sendTimeseriesGS2Response()
        {
        }
        
        public sendTimeseriesGS2Response(string messageID, string referringMessageID, StatusType status, string statusCode, string statusMessage)
        {
