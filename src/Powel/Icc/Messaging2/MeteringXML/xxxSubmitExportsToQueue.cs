...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    public partial class submitExportsToQueue
    {
        ...
        public submitExportsToQueue()
        {
        }
        
        public submitExportsToQueue(string messageID, UtcTime validFrom, ExportInfoType exportInfo, SecurityType security)
        {
