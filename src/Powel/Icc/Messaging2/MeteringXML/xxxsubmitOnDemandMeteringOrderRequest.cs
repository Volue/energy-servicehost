...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="submitOnDemandMeteringOrder", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class submitOnDemandMeteringOrderRequest
    {
        ...
        public OnDemandMeteringOrderTypeIn onDemandMeteringOrderIn;

        [System.ServiceModel.MessageBodyMemberAttribute(Namespace = "http://www.powel.no/icc/ws/metering/messages/1.5/", Order = 3)]
        public SecurityType security;
        
        public submitOnDemandMeteringOrderRequest()
        {
        }
        
        public submitOnDemandMeteringOrderRequest(string messageID, UtcTime validFrom, OnDemandMeteringOrderTypeIn onDemandMeteringOrderIn, SecurityType security)
        {
            this.messageID = messageID;
            this.validFrom = validFrom;
            this.onDemandMeteringOrderIn = onDemandMeteringOrderIn;
