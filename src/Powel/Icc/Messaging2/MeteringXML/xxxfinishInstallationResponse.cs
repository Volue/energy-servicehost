namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="finishInstallationResponse", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class finishInstallationResponse
    {
        ...
        public finishInstallationResponse()
        {
        }
        
        public finishInstallationResponse(string messageID, string referringMessageID, StatusType status, string statusCode, string statusMessage)
        {
