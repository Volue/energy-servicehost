namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="sendOnDemandMeteringOrderResponse", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class sendOnDemandMeteringOrderResponse
    {
        ...
        public sendOnDemandMeteringOrderResponse()
        {
        }
        
        public sendOnDemandMeteringOrderResponse(string messageID, string referringMessageID, System.Collections.Generic.List<StatusItemType> statuses)
        {
