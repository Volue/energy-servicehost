...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    public partial class submitInstallationToQueue
    {
        ...
        public submitInstallationToQueue()
        {
        }
        
        public submitInstallationToQueue(string messageID, UtcTime validFrom, ActionType action, InstallationType installation)
        {
