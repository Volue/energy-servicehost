...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    public partial class submitRegistersToQueue
    {
        ...
        public submitRegistersToQueue()
        {
        }
        
        public submitRegistersToQueue(string messageID, UtcTime validFrom, RegisterInfoType registerInfo, SecurityType security)
        {
