...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="submitExports", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class submitExportsRequest
    {
        ...
        public submitExportsRequest()
        {
        }
        
        public submitExportsRequest(string messageID, UtcTime validFrom, ExportInfoType exportInfo, SecurityType security)
        {
