namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="submitRegistersResponse", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class submitRegistersResponse
    {
        ...
        public submitRegistersResponse()
        {
        }
        
        public submitRegistersResponse(string messageID, string referringMessageID, StatusType status, string statusCode, string statusMessage)
        {
