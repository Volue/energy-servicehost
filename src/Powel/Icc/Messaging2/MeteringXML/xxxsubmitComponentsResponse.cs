namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="submitComponentsResponse", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class submitComponentsResponse
    {
        ...
        public submitComponentsResponse()
        {
        }
        
        public submitComponentsResponse(string messageID, string referringMessageID, StatusType status, string statusCode, string statusMessage)
        {
