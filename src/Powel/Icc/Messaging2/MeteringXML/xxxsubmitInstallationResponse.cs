namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="submitInstallationResponse", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class submitInstallationResponse
    {
        ...
        public submitInstallationResponse()
        {
        }
        
        public submitInstallationResponse(string messageID, string referringMessageID, StatusType status, string statusCode, string statusMessage)
        {
