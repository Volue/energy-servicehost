...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="sendOnDemandMeteringOrder", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class sendOnDemandMeteringOrderRequest
    {
        ...
        public OnDemandMeteringOrderTypeOut onDemandMeteringOrderOut;
        
        public sendOnDemandMeteringOrderRequest()
        {
        }
        
        public sendOnDemandMeteringOrderRequest(string messageID, UtcTime validFrom, OnDemandMeteringOrderTypeOut onDemandMeteringOrderOut)
        {
            this.messageID = messageID;
            this.validFrom = validFrom;
            this.onDemandMeteringOrderOut = onDemandMeteringOrderOut;
        }
    }
}
