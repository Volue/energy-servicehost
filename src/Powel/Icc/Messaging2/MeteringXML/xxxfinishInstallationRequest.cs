...
namespace Powel.Icc.Messaging2.MeteringXML
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="finishInstallation", WrapperNamespace="http://www.powel.no/icc/ws/metering/messages/1.5/", IsWrapped=true)]
    public partial class finishInstallationRequest
    {
        ...
        public finishInstallationRequest()
        {
        }
        
        public finishInstallationRequest(string messageID, UtcTime validFrom, string installationID, SecurityType security)
        {
